...
var $author$project$Pages$Scoreboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			...
			$author$project$Pages$Scoreboard$getMatches('/scoreboard-backend/graphql'));
	});
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			...
			A2($author$project$Pages$Scoreboard$Matches$Id_Int$getMatch, url.params.id, '/scoreboard-backend/graphql'));
	});
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotMatch') {
			...
			return _Utils_Tuple2(
				model,
				A4($author$project$Pages$Scoreboard$Matches$Id_Int$createScoreChange, '/scoreboard-backend/graphql', player, change, matchId));
		}
	});
