...
{
	if (region.aH.bZ === region.aT.bZ)
	{
		return 'on line ' + region.aH.bZ;
	}
	return 'on lines ' + region.aH.bZ + ' through ' + region.aT.bZ;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bU: 'hidden', aO: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bU: 'mozHidden', aO: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bU: 'msHidden', aO: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bU: 'webkitHidden', aO: 'webkitvisibilitychange' }
		: { bU: 'hidden', aO: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aB, request.cE, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aW: fragment, a$: host, a9: path, be: port_, bh: protocol, aF: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {B: frag, ck: params, A: unvisited, x: value, G: visited};
	});
...
var $author$project$Spa$Generated$Route$Scoreboard = {$: 1};
...
var $author$project$Shared$Model = F3(
	function (url, key, config) {
		return {af: config, bY: key, cE: url};
	});
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{cF: $author$project$Pages$NotFound$view});
var $author$project$Spa$Page$application = function (page) {
	return page;
};
var $krisajenkins$remotedata$RemoteData$NotAsked = {$: 0};
var $author$project$Pages$Scoreboard$GotMatches = $elm$core$Basics$identity;
...
var $author$project$Pages$Scoreboard$Match = F5(
	function (id, game, playerOne, playerTwo, scoreChanges) {
		return {aX: game, a0: id, bc: playerOne, bd: playerTwo, cr: scoreChanges};
	});
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {I: charsProcessed, K: hash, F: seed, O: shift};
	});
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$hashFold = F2(
	function (c, data) {
		var res = data.K | ((255 & $elm$core$Char$toCode(c)) << data.O);
		var _v0 = data.O;
		if (_v0 === 24) {
			return {
				I: data.I + 1,
			...
			return {I: data.I + 1, K: res, F: data.F, O: data.O + 8};
		}
	});
	...
	return A2(
		...
		function () {
			if (!field.$) {
				...
				var typeString = field.a.cC;
				var fieldName = field.a.aV;
				var _arguments = field.b;
...
var $author$project$Backend$Scalar$ISO8601DateTime = $elm$core$Basics$identity;
var $author$project$Backend$Scalar$Id = $elm$core$Basics$identity;
...
var $author$project$Backend$Scalar$defaultCodecs = {
	aQ: {
		av: A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
		ax: function (_v0) {
			var raw = _v0;
...
var $author$project$Backend$Scalar$Codecs = $elm$core$Basics$identity;
...
var $author$project$Backend$ScalarCodecs$codecs = $author$project$Backend$Scalar$defineCodecs(
	{aQ: $author$project$Backend$Scalar$defaultCodecs.aQ, bJ: $author$project$Backend$Scalar$defaultCodecs.bJ});
...
var $author$project$Backend$Object$Match$id = A4(
	...
	'id',
	_List_Nil,
	$author$project$Backend$Scalar$unwrapCodecs($author$project$Backend$ScalarCodecs$codecs).bJ.av);
...
var $dillonkearns$elm_graphql$Graphql$Http$queryRequest = F2(
	function (baseUrl, query) {
		return {
			...
			X: $dillonkearns$elm_graphql$Graphql$Document$decoder(query),
			bT: _List_Nil,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bD: false, bF: r.bF, X: r.X, bT: r.bT, aB: r.aB, bv: r.bv, bw: r.bw, cE: r.cE}));
};
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bD: true, bF: r.bF, X: r.X, bT: r.bT, aB: r.aB, bv: r.bv, bw: r.bw, cE: r.cE}));
};
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bW: index, b0: match, ce: number, cw: submatches};
	});
	...
	function (forceMethod, url, queryParams, maybeOperationName, queryDocument) {
		...
		if (_Utils_eq(
			...
			return {
				...
				aB: 1,
				cE: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, _List_Nil, url)
			};
		} else {
			return {bF: $elm$http$Http$emptyBody, aB: 0, cE: urlForGetRequest};
		}
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$GraphqlError$GraphqlError = F3(
	function (message, locations, details) {
		return {ah: details, b$: locations, b1: message};
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$toReadyRequest = function (_v0) {
	...
	if (!_v1.$) {
		...
		var queryRequestDetails = A5(
			...
			querySelectionSet);
		return {
			bF: queryRequestDetails.bF,
			av: $dillonkearns$elm_graphql$Graphql$Http$decoderOrError(request.X),
			bT: request.bT,
			aB: function () {
				var _v2 = queryRequestDetails.aB;
				if (!_v2) {
					return 'GET';
				} else {
					return 'Post';
		...
		return {
			...
			aB: 'POST',
			bv: request.bv,
			cE: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, request.C, request.T)
		};
	}
};
...
var $author$project$Pages$Scoreboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{af: shared.af, aj: $krisajenkins$remotedata$RemoteData$NotAsked, cE: url},
			$author$project$Pages$Scoreboard$getMatches(
				$author$project$Pages$Scoreboard$webRootFromConfig(shared.af) + '/scoreboard-backend/graphql'));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						'/scoreboard/matches/' + $elm$core$String$fromInt(match.a0))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(match.aX + (' - ' + (match.bc + (' vs ' + match.bd))))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Scoreboard$bodyView(model.aj)
			]));
};
...
var $author$project$Pages$Scoreboard$page = $author$project$Spa$Page$application(
	{bX: $author$project$Pages$Scoreboard$init, b_: $author$project$Pages$Scoreboard$load, cq: $author$project$Pages$Scoreboard$save, cx: $author$project$Pages$Scoreboard$subscriptions, cD: $author$project$Pages$Scoreboard$update, cF: $author$project$Pages$Scoreboard$view});
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{af: shared.af, ai: $krisajenkins$remotedata$RemoteData$NotAsked, cE: url},
			A2(
				$author$project$Pages$Scoreboard$Matches$Id_Int$getMatch,
				url.ck.a0,
				$author$project$Pages$Scoreboard$Matches$Id_Int$webRootFromConfig(shared.af) + '/scoreboard-backend/graphql'));
	});
...
var $author$project$Backend$Mutation$createScoreChange = F2(
	function (requiredArgs, object_) {
		return A4(
			...
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'player', requiredArgs.bb, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string),
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'change', requiredArgs.aO, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int),
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'matchId', requiredArgs.a3, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)
				]),
			object_,
			$elm$core$Basics$identity);
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$mutationRequest = F2(
	function (baseUrl, mutationSelectionSet) {
		return {
			...
			X: $dillonkearns$elm_graphql$Graphql$Document$decoder(mutationSelectionSet),
			bT: _List_Nil,
			N: $elm$core$Maybe$Nothing,
			C: _List_Nil,
			bv: $elm$core$Maybe$Nothing,
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					{aO: change, a3: matchId, bb: player},
					$author$project$Pages$Scoreboard$Matches$Id_Int$matchSelection)));
	});
		...
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				...
				A4(
					...
					$author$project$Pages$Scoreboard$Matches$Id_Int$webRootFromConfig(model.af) + '/scoreboard-backend/graphql',
					player,
					change,
					matchId));
		}
		...
		return A3(
			...
			F2(
				function (scoreChange, acc) {
					return _Utils_eq(scoreChange.bb, player) ? (acc + scoreChange.aO) : acc;
				}),
			0,
			scoreChanges);
	});
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromInt(
											A2($author$project$Pages$Scoreboard$Matches$Id_Int$scoreForPlayer, match.cr, match.bc)))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												A3($author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChanged, match.a0, match.bc, -1))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('-')
							...
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(
											A2($author$project$Pages$Scoreboard$Matches$Id_Int$scoreForPlayer, match.cr, match.bd)))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('btn btn-light w-25 h-25'),
												$elm$html$Html$Events$onClick(
												A3($author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChanged, match.a0, match.bd, -1))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('-')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Scoreboard$Matches$Id_Int$bodyView(model.ai)
			]));
};
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$page = $author$project$Spa$Page$application(
	{bX: $author$project$Pages$Scoreboard$Matches$Id_Int$init, b_: $author$project$Pages$Scoreboard$Matches$Id_Int$load, cq: $author$project$Pages$Scoreboard$Matches$Id_Int$save, cx: $author$project$Pages$Scoreboard$Matches$Id_Int$subscriptions, cD: $author$project$Pages$Scoreboard$Matches$Id_Int$update, cF: $author$project$Pages$Scoreboard$Matches$Id_Int$view});
	...
	function (params, key, url) {
		return {
			...
			aF: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.aF)),
			bi: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.bX,
						shared,
						A3($author$project$Spa$Url$create, params, shared.bY, shared.cE)));
			});
		...
		return {U: bundle_, bX: init_, cD: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	...
	as: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Scoreboard__Model, $author$project$Spa$Generated$Pages$Scoreboard__Msg, $author$project$Pages$Scoreboard$page),
	at: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Scoreboard__Matches__Id_Int__Model, $author$project$Spa$Generated$Pages$Scoreboard__Matches__Id_Int__Msg, $author$project$Pages$Scoreboard$Matches$Id_Int$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.an.bX(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.as.bX(0);
		default:
			var params = route.a;
			return $author$project$Spa$Generated$Pages$pages.at.bX(params);
	}
};
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.an.U(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.as.U(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.at.U(model);
	}
};
var $author$project$Spa$Generated$Pages$save = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).cq(0);
};
...
var $author$project$Spa$Document$toBrowserDocument = function (doc) {
	return {bF: doc.bF, cA: doc.cA};
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).b_(0);
};
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.an.cD, msg, model);
					} else {
						break _v0$3;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.as.cD, msg, model);
					} else {
						break _v0$3;
					}
				default:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.at.cD, msg, model);
					} else {
						break _v0$3;
					}
			}
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		cF: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
