...
var $author$project$Spa$Generated$Route$Scoreboard = {$: 'Scoreboard'};
var $author$project$Spa$Generated$Route$Scoreboard__Matches__Id_Int = function (a) {
	return {$: 'Scoreboard__Matches__Id_Int', a: a};
};
...
var $author$project$Spa$Generated$Route$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Spa$Generated$Route$Scoreboard,
			$elm$url$Url$Parser$s('scoreboard')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Spa$Generated$Route$Scoreboard__Matches__Id_Int,
			A2(
				$elm$url$Url$Parser$map,
				function (id) {
					return {id: id};
...
var $author$project$Shared$Model = F3(
	function (url, key, config) {
		return {config: config, key: key, url: url};
	});
var $author$project$Shared$init = F3(
	function (config, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Shared$Model, url, key, config),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Spa$Generated$Pages$Scoreboard__Matches__Id_Int__Model = function (a) {
	return {$: 'Scoreboard__Matches__Id_Int__Model', a: a};
};
var $author$project$Spa$Generated$Pages$Scoreboard__Matches__Id_Int__Msg = function (a) {
	return {$: 'Scoreboard__Matches__Id_Int__Msg', a: a};
};
var $author$project$Spa$Generated$Pages$Scoreboard__Model = function (a) {
	return {$: 'Scoreboard__Model', a: a};
};
var $author$project$Spa$Generated$Pages$Scoreboard__Msg = function (a) {
	return {$: 'Scoreboard__Msg', a: a};
};
...
var $author$project$Pages$Scoreboard$GotMatches = function (a) {
	return {$: 'GotMatches', a: a};
};
...
var $author$project$Pages$Scoreboard$Match = F5(
	function (id, game, playerOne, playerTwo, scoreChanges) {
		return {game: game, id: id, playerOne: playerOne, playerTwo: playerTwo, scoreChanges: scoreChanges};
	});
...
var $author$project$Backend$Object$Match$game = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'game', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$Backend$Scalar$ISO8601DateTime = function (a) {
...
var $author$project$Backend$Scalar$defaultCodecs = {
	codecISO8601DateTime: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$Backend$Scalar$ISO8601DateTime, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
...
var $author$project$Backend$ScalarCodecs$codecs = $author$project$Backend$Scalar$defineCodecs(
	{codecISO8601DateTime: $author$project$Backend$Scalar$defaultCodecs.codecISO8601DateTime, codecId: $author$project$Backend$Scalar$defaultCodecs.codecId});
var $author$project$Backend$Scalar$unwrapCodecs = function (_v0) {
	var unwrappedCodecs = _v0.a;
	return unwrappedCodecs;
};
var $author$project$Backend$Object$Match$id = A4(
...
var $author$project$Pages$Scoreboard$idToInt = function (_v0) {
	var id = _v0.a;
	return A2(
		$elm$core$Maybe$withDefault,
		0,
...
var $author$project$Backend$Object$Match$playerOne = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'playerOne', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$Backend$Object$Match$playerTwo = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'playerTwo', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$Pages$Scoreboard$ScoreChange = F2(
	function (player, change) {
		return {change: change, player: player};
	});
var $author$project$Backend$Object$ScoreChange$change = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Int', 'change', _List_Nil, $elm$json$Json$Decode$int);
var $author$project$Backend$Object$ScoreChange$player = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'player', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$Pages$Scoreboard$scoreChangeSelection = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	$author$project$Backend$Object$ScoreChange$change,
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		$author$project$Backend$Object$ScoreChange$player,
		$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Pages$Scoreboard$ScoreChange)));
...
var $author$project$Backend$Object$Match$scoreChanges = function (object_) {
	return A4(
...
var $author$project$Pages$Scoreboard$matchSelection = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	$author$project$Backend$Object$Match$scoreChanges($author$project$Pages$Scoreboard$scoreChangeSelection),
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		$author$project$Backend$Object$Match$playerTwo,
		A2(
			$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
			$author$project$Backend$Object$Match$playerOne,
			A2(
				$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
				$author$project$Backend$Object$Match$game,
				A2(
					$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
					A2($dillonkearns$elm_graphql$Graphql$SelectionSet$map, $author$project$Pages$Scoreboard$idToInt, $author$project$Backend$Object$Match$id),
					$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Pages$Scoreboard$Match))))));
var $author$project$Backend$Query$matches = function (object_) {
	return A4(
		$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField,
		'matches',
		_List_Nil,
...
var $author$project$Pages$Scoreboard$getMatches = function (graphqlUrl) {
	return A2(
		$dillonkearns$elm_graphql$Graphql$Http$send,
		A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Pages$Scoreboard$GotMatches),
		A2(
			$dillonkearns$elm_graphql$Graphql$Http$queryRequest,
			graphqlUrl,
			$author$project$Backend$Query$matches($author$project$Pages$Scoreboard$matchSelection)));
};
var $author$project$Pages$Scoreboard$webRootFromConfig = function (config) {
	var _v0 = config.node_env;
	switch (_v0) {
		case 'development':
			return 'http://localhost:3000';
		case 'production':
			return 'https://casper.coffee';
		default:
			return 'http://localhost:3000';
	}
};
var $author$project$Pages$Scoreboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{config: shared.config, getMatchesResponse: $krisajenkins$remotedata$RemoteData$NotAsked, url: url},
			$author$project$Pages$Scoreboard$getMatches(
				$author$project$Pages$Scoreboard$webRootFromConfig(shared.config) + '/scoreboard-backend/graphql'));
	});
var $author$project$Pages$Scoreboard$load = F2(
	function (shared, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Scoreboard$save = F2(
	function (model, shared) {
		return shared;
	});
var $author$project$Pages$Scoreboard$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Scoreboard$update = F2(
	function (msg, model) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{getMatchesResponse: response}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Scoreboard$matchView = function (match) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						'/scoreboard/matches/' + $elm$core$String$fromInt(match.id))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(match.game + (' - ' + (match.playerOne + (' vs ' + match.playerTwo))))
					]))
			]));
};
var $author$project$Pages$Scoreboard$bodyView = function (response) {
	switch (response.$) {
		case 'NotAsked':
		...
		case 'Failure':
			return $elm$html$Html$text('Something failed');
		default:
			var matches = response.a;
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				A2($elm$core$List$map, $author$project$Pages$Scoreboard$matchView, matches));
	}
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$Pages$Scoreboard$viewNav = A2(
	$elm$html$Html$nav,
	_List_fromArray(
		[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('/scoreboard'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('/scoreboard/matches/new'),
							A2($elm$html$Html$Attributes$style, 'text-decoration', 'none'),
							A2($elm$html$Html$Attributes$style, 'color', 'white')
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('/auth/signout'),
							A2($elm$html$Html$Attributes$style, 'text-decoration', 'none'),
							A2($elm$html$Html$Attributes$style, 'color', 'white')
						]),
					_List_fromArray(
...
var $author$project$Pages$Scoreboard$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Pages$Scoreboard$viewNav,
				A2(
				$elm$html$Html$h1,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'margin', '35px')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Scoreboard')
					])),
				$author$project$Pages$Scoreboard$bodyView(model.getMatchesResponse)
			]));
};
var $author$project$Pages$Scoreboard$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Pages$Scoreboard$viewBody(model)
			]),
		title: 'Home - Scoreboard'
	};
};
var $author$project$Pages$Scoreboard$page = $author$project$Spa$Page$application(
	{init: $author$project$Pages$Scoreboard$init, load: $author$project$Pages$Scoreboard$load, save: $author$project$Pages$Scoreboard$save, subscriptions: $author$project$Pages$Scoreboard$subscriptions, update: $author$project$Pages$Scoreboard$update, view: $author$project$Pages$Scoreboard$view});
var $author$project$Pages$Scoreboard$Matches$Id_Int$GotMatch = function (a) {
	return {$: 'GotMatch', a: a};
};
...
var $author$project$Backend$Scalar$unwrapEncoder = F2(
	function (getter, _v0) {
		var unwrappedCodecs = _v0.a;
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Backend$Query$match = F2(
		...
		return A4(
			...
			_List_fromArray(
				[
					...
					requiredArgs.id,
					A2(
						$author$project$Backend$Scalar$unwrapEncoder,
						function ($) {
							return $.codecId;
						},
						$author$project$Backend$ScalarCodecs$codecs))
				]),
			object_,
			$elm$core$Basics$identity);
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$Match = F5(
	function (id, game, playerOne, playerTwo, scoreChanges) {
		return {game: game, id: id, playerOne: playerOne, playerTwo: playerTwo, scoreChanges: scoreChanges};
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$idToInt = function (_v0) {
	var id = _v0.a;
	return A2(
		$elm$core$Maybe$withDefault,
		0,
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChange = F2(
	function (player, change) {
		return {change: change, player: player};
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$scoreChangeSelection = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	$author$project$Backend$Object$ScoreChange$change,
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		$author$project$Backend$Object$ScoreChange$player,
		$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChange)));
var $author$project$Pages$Scoreboard$Matches$Id_Int$matchSelection = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	$author$project$Backend$Object$Match$scoreChanges($author$project$Pages$Scoreboard$Matches$Id_Int$scoreChangeSelection),
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		$author$project$Backend$Object$Match$playerTwo,
		A2(
			...
			A2(
				...
				A2(
					$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
					A2($dillonkearns$elm_graphql$Graphql$SelectionSet$map, $author$project$Pages$Scoreboard$Matches$Id_Int$idToInt, $author$project$Backend$Object$Match$id),
					$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Pages$Scoreboard$Matches$Id_Int$Match))))));
var $author$project$Pages$Scoreboard$Matches$Id_Int$getMatch = F2(
	function (id, graphqlUrl) {
		return A2(
			$dillonkearns$elm_graphql$Graphql$Http$send,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Pages$Scoreboard$Matches$Id_Int$GotMatch),
			A2(
				$dillonkearns$elm_graphql$Graphql$Http$queryRequest,
				graphqlUrl,
				A2(
					$author$project$Backend$Query$match,
					{
						id: $author$project$Backend$Scalar$Id(
							$elm$core$String$fromInt(id))
					},
					$author$project$Pages$Scoreboard$Matches$Id_Int$matchSelection)));
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$webRootFromConfig = function (config) {
	var _v0 = config.node_env;
	switch (_v0) {
		case 'development':
			return 'http://localhost:3000';
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{config: shared.config, getMatchResponse: $krisajenkins$remotedata$RemoteData$NotAsked, url: url},
			A2(
				$author$project$Pages$Scoreboard$Matches$Id_Int$getMatch,
				url.params.id,
				$author$project$Pages$Scoreboard$Matches$Id_Int$webRootFromConfig(shared.config) + '/scoreboard-backend/graphql'));
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$load = F2(
	function (shared, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$save = F2(
	function (model, shared) {
		return shared;
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
...
var $author$project$Backend$Mutation$createScoreChange = F2(
	function (requiredArgs, object_) {
		return A4(
			$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField,
			'createScoreChange',
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'player', requiredArgs.player, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string),
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'change', requiredArgs.change, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int),
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'matchId', requiredArgs.matchId, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)
				]),
			object_,
			$elm$core$Basics$identity);
	});
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$createScoreChange = F4(
	function (graphqlUrl, player, change, matchId) {
		return A2(
			$dillonkearns$elm_graphql$Graphql$Http$send,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Pages$Scoreboard$Matches$Id_Int$GotMatch),
			A2(
				...
				graphqlUrl,
				A2(
					$author$project$Backend$Mutation$createScoreChange,
					{change: change, matchId: matchId, player: player},
					$author$project$Pages$Scoreboard$Matches$Id_Int$matchSelection)));
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotMatch') {
			var response = msg.a;
			return _Utils_Tuple2(
			...
			return _Utils_Tuple2(
				model,
				A4(
					$author$project$Pages$Scoreboard$Matches$Id_Int$createScoreChange,
					$author$project$Pages$Scoreboard$Matches$Id_Int$webRootFromConfig(model.config) + '/scoreboard-backend/graphql',
					player,
					change,
					matchId));
		}
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChanged = F3(
	function (a, b, c) {
		return {$: 'ScoreChanged', a: a, b: b, c: c};
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$scoreForPlayer = F2(
	function (scoreChanges, player) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (scoreChange, acc) {
					return _Utils_eq(scoreChange.player, player) ? (acc + scoreChange.change) : acc;
				}),
			0,
			scoreChanges);
	});
var $author$project$Pages$Scoreboard$Matches$Id_Int$matchView = function (match) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col h-100')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('player-one')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('col justify-content-center align-content-center')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(match.playerOne)
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromInt(
											A2($author$project$Pages$Scoreboard$Matches$Id_Int$scoreForPlayer, match.scoreChanges, match.playerOne)))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('row h-100 justify-content-center')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('btn btn-light w-25 h-25'),
												$elm$html$Html$Events$onClick(
												A3($author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChanged, match.id, match.playerOne, -1))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('-')
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('btn btn-light w-25 h-25 ml-4'),
												$elm$html$Html$Events$onClick(
												A3($author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChanged, match.id, match.playerOne, 1))
											]),
										_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('player-two')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(match.playerTwo)
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(
											A2($author$project$Pages$Scoreboard$Matches$Id_Int$scoreForPlayer, match.scoreChanges, match.playerTwo)))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('btn btn-light w-25 h-25'),
												$elm$html$Html$Events$onClick(
												A3($author$project$Pages$Scoreboard$Matches$Id_Int$ScoreChanged, match.id, match.playerTwo, -1))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('-')
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$bodyView = function (response) {
	switch (response.$) {
		case 'NotAsked':
			return $elm$html$Html$text('Not Asked');
		case 'Loading':
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Pages$Scoreboard$Matches$Id_Int$matchView(match)
					]));
	}
};
var $author$project$Pages$Scoreboard$Matches$Id_Int$viewNav = A2(
	$elm$html$Html$nav,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('navbar navbar-dark bg-dark'),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Back to Matches')
						]))
				])),
			A2(
			$elm$html$Html$div,
...
var $author$project$Pages$Scoreboard$Matches$Id_Int$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Pages$Scoreboard$Matches$Id_Int$viewNav,
				A2(
				$elm$html$Html$h1,
				_List_fromArray(
					[
				...
				$author$project$Pages$Scoreboard$Matches$Id_Int$bodyView(model.getMatchResponse)
			]));
};
var $author$project$Pages$Scoreboard$Matches$Id_Int$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Pages$Scoreboard$Matches$Id_Int$viewBody(model)
			]),
		title: 'Home - Scoreboard'
	};
};
var $author$project$Pages$Scoreboard$Matches$Id_Int$page = $author$project$Spa$Page$application(
	{init: $author$project$Pages$Scoreboard$Matches$Id_Int$init, load: $author$project$Pages$Scoreboard$Matches$Id_Int$load, save: $author$project$Pages$Scoreboard$Matches$Id_Int$save, subscriptions: $author$project$Pages$Scoreboard$Matches$Id_Int$subscriptions, update: $author$project$Pages$Scoreboard$Matches$Id_Int$update, view: $author$project$Pages$Scoreboard$Matches$Id_Int$view});
...
var $author$project$Spa$Generated$Pages$pages = {
	...
	scoreboard: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Scoreboard__Model, $author$project$Spa$Generated$Pages$Scoreboard__Msg, $author$project$Pages$Scoreboard$page),
	scoreboard__matches__id_int: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Scoreboard__Matches__Id_Int__Model, $author$project$Spa$Generated$Pages$Scoreboard__Matches__Id_Int__Msg, $author$project$Pages$Scoreboard$Matches$Id_Int$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Scoreboard':
			return $author$project$Spa$Generated$Pages$pages.scoreboard.init(_Utils_Tuple0);
		default:
			var params = route.a;
			return $author$project$Spa$Generated$Pages$pages.scoreboard__matches__id_int.init(params);
	}
};
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		...
		case 'Scoreboard__Model':
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.scoreboard.bundle(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.scoreboard__matches__id_int.bundle(model);
	}
};
	...
	function (bigMsg, bigModel) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'Scoreboard__Msg':
					if (_v0.b.$ === 'Scoreboard__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.scoreboard.update, msg, model);
					} else {
						break _v0$3;
					}
				default:
					if (_v0.b.$ === 'Scoreboard__Matches__Id_Int__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.scoreboard__matches__id_int.update, msg, model);
					} else {
						break _v0$3;
					}
			}
			...
			return A2(
				...
				function (node_env) {
					return $elm$json$Json$Decode$succeed(
						{node_env: node_env, session: session});
				},
				A2($elm$json$Json$Decode$field, 'node_env', $elm$json$Json$Decode$string));
		},
		A2($elm$json$Json$Decode$field, 'session', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Graphql.Http.Error":{"args":["parsedData"],"type":"Graphql.Http.RawError parsedData Graphql.Http.HttpError"},"Pages.Scoreboard.Match":{"args":[],"type":"{ id : Basics.Int, game : String.String, playerOne : String.String, playerTwo : String.String, scoreChanges : List.List Pages.Scoreboard.ScoreChange }"},"Pages.Scoreboard.Matches.Id_Int.Match":{"args":[],"type":"{ id : Basics.Int, game : String.String, playerOne : String.String, playerTwo : String.String, scoreChanges : List.List Pages.Scoreboard.Matches.Id_Int.ScoreChange }"},"Pages.Scoreboard.ScoreChange":{"args":[],"type":"{ player : String.String, change : Basics.Int }"},"Pages.Scoreboard.Matches.Id_Int.ScoreChange":{"args":[],"type":"{ player : String.String, change : Basics.Int }"},"Graphql.Http.GraphqlError.GraphqlError":{"args":[],"type":"{ message : String.String, locations : Maybe.Maybe (List.List Graphql.Http.GraphqlError.Location), details : Dict.Dict String.String Json.Decode.Value }"},"Graphql.Http.GraphqlError.Location":{"args":[],"type":"{ line : Basics.Int, column : Basics.Int }"},"Http.Metadata":{"args":[],"type":"{ url : String.String, statusCode : Basics.Int, statusText : String.String, headers : Dict.Dict String.String String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"ReplaceMe":[]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"NotFound__Msg":["Pages.NotFound.Msg"],"Scoreboard__Msg":["Pages.Scoreboard.Msg"],"Scoreboard__Matches__Id_Int__Msg":["Pages.Scoreboard.Matches.Id_Int.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.Scoreboard.Msg":{"args":[],"tags":{"GotMatches":["RemoteData.RemoteData (Graphql.Http.Error (List.List Pages.Scoreboard.Match)) (List.List Pages.Scoreboard.Match)"]}},"Pages.Scoreboard.Matches.Id_Int.Msg":{"args":[],"tags":{"GotMatch":["RemoteData.RemoteData (Graphql.Http.Error Pages.Scoreboard.Matches.Id_Int.Match) Pages.Scoreboard.Matches.Id_Int.Match"],"ScoreChanged":["Basics.Int","String.String","Basics.Int"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Graphql.Http.HttpError":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Metadata","String.String"],"BadPayload":["Json.Decode.Error"]}},"List.List":{"args":["a"],"tags":{}},"Graphql.Http.RawError":{"args":["parsedData","httpError"],"tags":{"GraphqlError":["Graphql.Http.GraphqlError.PossiblyParsedData parsedData","List.List Graphql.Http.GraphqlError.GraphqlError"],"HttpError":["httpError"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Json.Decode.Error":{"args":[],"tags":{"Field":["String.String","Json.Decode.Error"],"Index":["Basics.Int","Json.Decode.Error"],"OneOf":["List.List Json.Decode.Error"],"Failure":["String.String","Json.Decode.Value"]}},"Graphql.Http.GraphqlError.PossiblyParsedData":{"args":["parsed"],"tags":{"ParsedData":["parsed"],"UnparsedData":["Json.Decode.Value"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));