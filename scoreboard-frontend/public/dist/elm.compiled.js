...
var $author$project$Pages$Top$GotMatches = function (a) {
...
var $author$project$Pages$Top$Match = F5(
...
var $author$project$Pages$Top$idToInt = function (_v0) {
	var id = _v0.a;
	return A2(
		$elm$core$Maybe$withDefault,
		0,
...
var $author$project$Pages$Top$ScoreChange = F2(
...
var $author$project$Pages$Top$scoreChangeSelection = A2(
	...
	A2(
		...
		$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Pages$Top$ScoreChange)));
...
var $author$project$Pages$Top$matchSelection = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	$author$project$Backend$Object$Match$scoreChanges($author$project$Pages$Top$scoreChangeSelection),
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		...
		A2(
			...
			A2(
				...
				A2(
					$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
					A2($dillonkearns$elm_graphql$Graphql$SelectionSet$map, $author$project$Pages$Top$idToInt, $author$project$Backend$Object$Match$id),
					$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Pages$Top$Match))))));
...
var $author$project$Pages$Top$getMatches = function (graphqlUrl) {
	return A2(
		$dillonkearns$elm_graphql$Graphql$Http$send,
		A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Pages$Top$GotMatches),
		A2(
			$dillonkearns$elm_graphql$Graphql$Http$queryRequest,
			graphqlUrl,
			$author$project$Backend$Query$matches($author$project$Pages$Top$matchSelection)));
};
var $author$project$Pages$Top$webRootFromConfig = function (config) {
...
var $author$project$Pages$Top$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			...
			$author$project$Pages$Top$getMatches(
				$author$project$Pages$Top$webRootFromConfig(shared.config) + '/scoreboard-backend/graphql'));
	});
...
var $author$project$Pages$Top$matchView = function (match) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Pages$Top$bodyView = function (response) {
	switch (response.$) {
		case 'NotAsked':
		...
		default:
			...
			return A2(
				...
				A2($elm$core$List$map, $author$project$Pages$Top$matchView, matches));
	}
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$Pages$Top$viewNav = A2(
	$elm$html$Html$nav,
	_List_fromArray(
		[
...
var $author$project$Pages$Top$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Pages$Top$viewNav,
				A2(
				$elm$html$Html$h1,
				_List_fromArray(
					[
				...
				$author$project$Pages$Top$bodyView(model.getMatchesResponse)
			]));
};
var $author$project$Pages$Top$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Pages$Top$viewBody(model)
			]),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'session', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Graphql.Http.Error":{"args":["parsedData"],"type":"Graphql.Http.RawError parsedData Graphql.Http.HttpError"},"Pages.Top.Match":{"args":[],"type":"{ id : Basics.Int, game : String.String, playerOne : String.String, playerTwo : String.String, scoreChanges : List.List Pages.Top.ScoreChange }"},"Pages.Top.ScoreChange":{"args":[],"type":"{ player : String.String, change : Basics.Int }"},"Graphql.Http.GraphqlError.GraphqlError":{"args":[],"type":"{ message : String.String, locations : Maybe.Maybe (List.List Graphql.Http.GraphqlError.Location), details : Dict.Dict String.String Json.Decode.Value }"},"Graphql.Http.GraphqlError.Location":{"args":[],"type":"{ line : Basics.Int, column : Basics.Int }"},"Http.Metadata":{"args":[],"type":"{ url : String.String, statusCode : Basics.Int, statusText : String.String, headers : Dict.Dict String.String String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"ReplaceMe":[]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"Top__Msg":["Pages.Top.Msg"],"NotFound__Msg":["Pages.NotFound.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.Top.Msg":{"args":[],"tags":{"GotMatches":["RemoteData.RemoteData (Graphql.Http.Error (List.List Pages.Top.Match)) (List.List Pages.Top.Match)"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Graphql.Http.HttpError":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Metadata","String.String"],"BadPayload":["Json.Decode.Error"]}},"List.List":{"args":["a"],"tags":{}},"Graphql.Http.RawError":{"args":["parsedData","httpError"],"tags":{"GraphqlError":["Graphql.Http.GraphqlError.PossiblyParsedData parsedData","List.List Graphql.Http.GraphqlError.GraphqlError"],"HttpError":["httpError"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Json.Decode.Error":{"args":[],"tags":{"Field":["String.String","Json.Decode.Error"],"Index":["Basics.Int","Json.Decode.Error"],"OneOf":["List.List Json.Decode.Error"],"Failure":["String.String","Json.Decode.Value"]}},"Graphql.Http.GraphqlError.PossiblyParsedData":{"args":["parsed"],"tags":{"ParsedData":["parsed"],"UnparsedData":["Json.Decode.Value"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));